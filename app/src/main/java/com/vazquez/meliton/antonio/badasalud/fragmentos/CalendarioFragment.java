...
public class CalendarioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //le indicamos que al seleccionar fecha se guarde en un objeto
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            @Override
            public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth) {
                String fecha="";

                fecha = Integer.toString(year) +"-"+ Integer.toString(month) +"-" +Integer.toString(dayOfMonth);
    ...
    private void cargarHora(String fecha) {
        Bundle bundle = new Bundle();
        bundle.putString("fecha", fecha);

        //instancio el fragmento
        Fragment fragment = new HoraFragment();
